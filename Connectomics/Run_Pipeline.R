...
itr=1
for (i in neurList) {
  sConnAll[[itr]]=getPrePostNRFAFB(ids=i,pre_post='outputs',nLayers=nLayers,connStrength=Thr)
...
save(adjFW, neurList, neurList_type, neurList_hemisphere, DN, DN_hemi, nLayers, Thr, file = "Data\\adjacencyDataFiles\\All_data_070423.RData")

# download the neurotransmitters
getALLNT(adjFW = adjFW, fileLoc = "Data\\NT_downloads\\")

# get the neurotransmitter adjacency matrix
getALLNT_adjacencyMat(adjFW = adjFW, fileLoc = "Data\\adjacencyDataFiles\\")
